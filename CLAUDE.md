...
- v6 roadmap: v6.1 controller async safety, v6.14 error logging, v6.2 AnimatedOpacity detection, v6.3 ShaderMask render detection, v6.4 nested scroll highlights — shipped.
- ~1,259 tests, 0 analysis issues

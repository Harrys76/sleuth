...
fvm flutter test                    # Run all tests (~1,869 tests, ~20s)
...
cd example && fvm flutter test            # Cookbook smoke tests (6 tests)
```

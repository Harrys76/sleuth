...
**v0.19.24** (current) — Test polish. Behavioral wiring test for `checkMinInBandSamplesPerSpec` (replaces source-grep) and explicit cwd guard on real-capture test. No detector changes; distribution unchanged. 3,000 tests passing.

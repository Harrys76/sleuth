...
- v6 roadmap: v6.1 controller async safety, v6.14 error logging, v6.2 AnimatedOpacity detection, v6.3 ShaderMask render detection — shipped.
- ~1,257 tests, 0 analysis issues

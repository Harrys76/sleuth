...
class OpacityDetector extends BaseDetector with DetectorMetadataProvider {
  ...
  DetectorMetadata get validationMetadata => const DetectorMetadata(
        ...
        rationale:
            ...
            'double-counted), the standalone FadeTransition emission path '
            '(bare FadeTransition settled at 0.0 fires; non-zero does not), '
            'and the nested-Opacity rollup shape (one issue with count '
            'reflecting both occurrences). Not yet runtime-verified on a '

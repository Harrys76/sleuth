...
| 8 | v9.8: Timeline Parser Over-Broad Names | Low | Accuracy | Shipped |
| 9 | v9.9: runtimeType.toString() Reduction | Medium | Performance | Shipped |
| 10 | v9.10: FrameStatsBuffer Hot-Path Allocations | Medium | Performance | Shipped |
| 11 | v9.11: Inner Subtree Walks (4 detectors) | Medium | Performance | Shipped |
| 12 | v9.12: _aggregateIssues Allocation Storm | Low | Performance | Shipped |
| 13 | v9.13: List.removeAt(0) → Queue | Low | Performance | Shipped |
| 14 | v9.14: Highlight Overlay Self-Overhead | Medium | Performance | Shipped |

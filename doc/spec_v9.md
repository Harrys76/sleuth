...
|----------|-----------|--------|-------|--------|
| 1 | v9.1: Opacity Value Semantics (3 detectors) | Medium | Accuracy | |
| 2 | v9.2: Paint Phase Thread Classification | Very Low | Accuracy | |
| 3 | v9.3: builtOnce Parameter Ignored | Very Low | Accuracy | |
| 4 | v9.4: Layout Bottleneck O(N²) Overclaim | Low | Accuracy | |
| 5 | v9.5: CustomPainter foregroundPainter | Very Low | Accuracy | |
| 6 | v9.6: Per-Scrollable Count Accumulation | Medium | Accuracy | |
| 7 | v9.7: Image Detector Size Threshold | Low | Accuracy | |
...
| 15 | v9.15: Silent Exception Swallowing | Very Low | Correctness | |
| 16 | v9.16: Mounted Check for ModalRoute.of | Very Low | Correctness | |
| 17 | v9.17: Source Location Cache Docstring | Very Low | Correctness | |

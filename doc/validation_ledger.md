...
_Last updated: v0.19.11 (2026-04-29)_
...
as of v0.19.17 (no detector raises; audit hardening adds `checkRuntimeVerifiedRequiresObservedAxisArgKey`). The detector-row tier reflects each detector's *base*

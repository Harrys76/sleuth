...
_Last updated: v0.17.6 (2026-04-25)_
...
as of v0.18.2. v0.18.0 raised `NetworkMonitorDetector.slow_request`
(warning tier, 1000 ms threshold) — first runtimeVerified raise.
v0.18.2 raised `HeavyComputeDetector.heavy_compute` (warning tier,

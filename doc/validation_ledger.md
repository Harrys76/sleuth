...
as of v0.19.16 (audit + schema polish; no detector raises). The detector-row tier reflects each detector's *base*
...
on the canonical warning bracket so every runtimeVerified bracket now
declares an observed-axis cross-check),

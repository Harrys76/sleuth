<!-- MCP-era per-version detail (0.32.0–0.35.0), moved out of CHANGELOG.md so the published changelog reads cleanly from 0.30.1 to 0.36.0. These versions were never published to pub.dev. -->
